...
class ConversationList extends StatefulWidget{
  ...
  bool isMessageRead;
  String userRole;
  ConversationList({required this.name,required this.messageText,required this.imageUrl,required this.time,required this.isMessageRead, required this.userRole,});
  @override
